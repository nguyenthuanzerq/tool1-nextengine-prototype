...
<head>
    ...
    <style>
        ...
        .container { max-w-[600px] margin: 0 auto; padding: 20px; border: 1px solid #ddd; }
        .header { background: #f8f9fa; padding: 15px; text-align: center; border-bottom: 2px solid #0056b3; }
        .content { padding: 20px 0; }
        .order-info { background: #f4f4f4; padding: 15px; margin-top: 20px; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="order-info">
                ...
                <p><strong>ご注文日時 (Ngày đặt):</strong> {{ $order->receive_order_date ?? $order->created_at->format('Y/m/d H:i') }}</p>
