  ...
  <div class="grid grid-cols-5 gap-6 mb-8">
    ...
    <div class="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-sm transition">
      <div class="w-12 h-12 rounded-xl bg-green-100 flex items-center justify-center mb-6">
        <svg viewBox="0 0 24 24" class="h-6 w-6 text-green-700" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-sm transition">
      <div class="w-12 h-12 rounded-xl bg-amber-100 flex items-center justify-center mb-6">
        <svg viewBox="0 0 24 24" class="h-6 w-6 text-amber-700" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-sm transition">
      <div class="w-12 h-12 rounded-xl bg-emerald-100 flex items-center justify-center mb-6">
        <svg viewBox="0 0 24 24" class="h-6 w-6 text-emerald-700" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M20 6L9 17l-5-5"/><path d="M20 6l-11 11"/>
        </svg>
      </div>
