    ...
    <div class="overflow-x-auto border border-gray-300">
        <table class="w-full border-collapse text-sm">
            ...
            <tr>
                ...
                <th class="border border-gray-300 px-3 py-3 text-left">ShopID</th>
                <th class="border border-gray-300 px-3 py-3 text-left">
                ...
                <th class="border border-gray-300 px-3 py-3 text-left">
                    注文者ID<br><span class="text-xs text-gray-600">(ID người đặt hàng)</span>
                </th>
                <th class="border border-gray-300 px-3 py-3 text-left">
                    注文者名<br><span class="text-xs text-gray-600">(Tên người đặt hàng)</span>
                </th>
                <th class="border border-gray-300 px-3 py-3 text-left">
                    配送先住所<br><span class="text-xs text-gray-600">(Địa chỉ người đặt hàng)</span>
                </th>
                <th class="border border-gray-300 px-3 py-3 text-left">
                    電話番号<br><span class="text-xs text-gray-600">(Số điện thoại)</span>
                </th>
                <th class="border border-gray-300 px-3 py-3 text-left">
                    メールアドレス<br><span class="text-xs text-gray-600">(Email người đặt hàng)</span>
                </th>
                <th class="border border-gray-300 px-3 py-3 text-left">
                    操作
                    <div class="text-xs text-gray-500">🔒 TBD: Mail logic</div>
                </th>
            </tr>
            </thead>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="border border-gray-300 px-3 py-2">ORD-20260210-001</td>
                <td class="border border-gray-300 px-3 py-2">カジュアルTシャツ（ホワイト・Mサイズ）</td>
                ...
                <td class="border border-gray-300 px-3 py-2">CUST-4521</td>
                <td class="border border-gray-300 px-3 py-2">田中 太郎</td>
                <td class="border border-gray-300 px-3 py-2">東京都渋谷区神南1-2-3 渋谷マンション101</td>
                <td class="border border-gray-300 px-3 py-2">090-1234-5678</td>
                <td class="border border-gray-300 px-3 py-2">tanaka.taro@example.com</td>
